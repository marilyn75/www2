                        ...
                        <div class="thumb detail_b_thumb">
                            <div class="single_product">
                                <div class="single_item">
                                    <div class="thumb detail_b_thumb"><img class="img-fluid" src="{{ $_img }}">
                                    </div>
                                </div>
                ...
                <div class="content">
                    <div class="shop_single_product_details">
                        ...
                        <div>
                            ...
                            <div class="detail_price mb15"><span class="mont">{{ $printData['price'] }}</span> 만원
                            </div>
                        </div>

                        <ul class="list_details list_details_w">
                            <li><a href="#"><i class="ri-checkbox-circle-line"></i>
                                    {{ $printData['prposAreaNm'] }}</a>
                            </li>
                            ...
                            @else
                                ...
                                @if (strpos($printData['category'], '토지') === false)
                                    <li><a href="#"><i class="ri-checkbox-circle-line"></i> 연면적
                                            {{ $printData['bdArea'] }}㎡</a>
                                    </li>
                                @endif
                            @endif
                        ...
                        <div class="col-lg-12 pl-0 pr-0">
                            <div class="additional_details additional_w">
                                ...
                                <ul class="list-inline-item detail_list row">
                                    ...
                                    <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                        <p>대지면적 :</p>
                                        <p class="mont">{{ $printData['landArea'] }}㎥
                                            ({{ $printData['landArea_py'] }}p)
                                        </p>
                                    </li>
                                    <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                        <p>지목 :</p>
                                    ...
                                    @if ($printData['isToji'] == false)
                                        ...
                                        @if (!empty($printData['area_b']))
                                            <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                                <p>분양면적 :</p>
                                                <p class="mont">{{ $printData['area_b'] }}㎥
                                                    ({{ $printData['area_b_py'] }}p)</p>
                                            </li>
                                            <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                                <p>전유면적 :</p>
                                                <p class="mont">{{ $printData['area_j'] }}㎥
                                                    ({{ $printData['area_j_py'] }}p)</p>
                                            </li>
                                        @else
                                            <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                                <p>연면적 :</p>
                                                <p class="mont">{{ $printData['bdArea'] }}㎥
                                                    ({{ $printData['bdArea_py'] }}p)</p>
                                            </li>
                                        @endif
                                        ...
                                        <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                            <p>규모 :</p>
                                            <p>지하 {{ $printData['ugrndFlrCnt'] }}층 / 지상
                                                {{ $printData['grndFlrCnt'] }}층</p>
                                        </li>
                                        <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                            <p>주차시설 :</p>
                                ...
                                <div class="additional_details additional_w">
                                    ...
                                    <ul class="list-inline-item detail_list row">
                                        ...
                                        @if ($printData['isJugeo'] == true)
                                            ...
                                            <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                                <p>방 / 화장실 :</p>
                                                <p>방 {{ $printData['room_num'] }}개 / 욕실
                                                    {{ $printData['restroom_num'] }}개</p>
                                            </li>
                                ...
                                @else
                                    <ul class="list-inline-item detail_list row">
                                        <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                            <p>보증금 :</p>
                                            <p><span
                                                    class="mont">{{ number_format($printData['depPrice']) }}</span>만원
                                            </p>
                                        </li>
                                        <li class="col-md-6 col-lg-6 col-xl-6 pl-0 pr-0">
                                            <p>월세 :</p>
                                            <p><span
                                                    class="mont">{{ number_format($printData['monPrice']) }}</span>만원
                                            </p>
                                        </li>
                                    </ul>
                                @endif
                                ...
                                @if (!empty($printData['infra']['주변시설']))
                                    <div class="education_distance mb15 style2 education_w">
                                        ...
                                        @foreach ($printData['infra']['주변시설'] as $_row)
                                            <div class="single_line single_w nearby-infra near"
                                                data-x="{{ $_row['x'] }}" data-y="{{ $_row['y'] }}">
                                                <p class="para">{{ $_row['place_name'] }}</p>
                                                <ul class="review">
                                                    <li class="list-inline-item">
                                ...
                                @if (!empty($printData['infra']['교통정보']))
                                    <div class="education_distance style3 education_w">
                                        ...
                                        @foreach ($printData['infra']['교통정보'] as $_row)
                                            <div class="single_line single_w nearby-infra traffic"
                                                data-x="{{ $_row['x'] }}" data-y="{{ $_row['y'] }}">
                                                <p class="para">{{ $_row['place_name'] }}</p>
                                                <ul class="review">
                                                    <li class="list-inline-item">
