        ...
        <nav>
            ...
            <ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
                ...
                <li class="user_setting">
                    <div class="dropdown">
                        <a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="{{ asset('images/team/e1.png') }}" alt="e1.png"> <span class="dn-1199">{{ Auth::user()->name }}</span></a>
