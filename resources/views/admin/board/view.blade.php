                    ...
                    <div class="mbp_pagination_tab">
                        <div class="row">
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <div class="pag_prev">
                                    <a href="{{ route('admin.board.show', $data->previousPost->id) }}"><span class="flaticon-back"></span></a>
                            ...
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <div class="pag_next text-right">
                                    <a href="{{ route('admin.board.show', $data->nextPost->id) }}"><span class="flaticon-next"></span></a>
