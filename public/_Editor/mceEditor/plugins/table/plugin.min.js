...
var table = (function () {
    ...
    var extractDataFromElement = function (editor, elm) {
      ...
      var data = {
		...
		class: dom.getAttrib(elm, 'class')? makeClassNameText(editor,dom.getAttrib(elm, 'class')) : "",
    ...
    var open$1 = function (editor) {
      ...
      if (getRowClassList(editor).length > 0) {
        classListCtrl = {
		  ...
		  //CS-LSH : 행속성에 Class 명칭 입력 기본폼 추가
		  classListCtrl = {
          name: 'class',
          type: 'textbox',
          label: 'Class Name',
    ...
    var extractDataFromElement$2 = function (editor, tableElm) {
      ...
      var data = {
        ...
        class: dom.getAttrib(tableElm, 'class')? makeClassNameText(editor,dom.getAttrib(tableElm, 'class')) : ""
      };
      global$1.each('left center right'.split(' '), function (name) {
	...
	// CS-LSH : 클래스 명칭 목록 
	var makeClassNameText = function(editor,clsNameStr){
		
		var cssStr =clsNameStr.replace(/\s*mce\-item\-table\s*/g, '');
		return cssStr;
	}
