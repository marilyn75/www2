...
<div class="rspnsv-cpannel pad15lr pad10tf" style="background:#f9f9f9;">
	...
	<div class="pad5t pad10f f11 vcen"><div class="editor-w-slider" style="display:inline-block;width:300px;"></div>&nbsp;&nbsp;&nbsp;&nbsp;(가로크기 : <span class="editor-w-str"><?=$conf["cont_w"]?>px - 모바일 or 태블릿</span>)</div>
...
$(".rspnsv-cpannel .editor-w-slider").slider({
...
docLoading(function(){ setEditorWidthAll(<?=$conf["cont_w"]?>); });
